      ...
      <main className="p-6 space-y-8 mt-4">
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <textarea value={note} onChange={(e) => setNote(e.target.value)} placeholder="Tulis detail pemasukan..." rows={3} className="w-full p-3 bg-gray-50 border border-gray-200 focus:outline-none focus:border-blue-500 rounded-lg resize-none"></textarea>
          </div>
