...
export default function AddIncome() {
  ...
  const handleSaveIncome = async () => {
    ...
    setIsSaving(true);
    // Simulasi User Siti. Di real-app, ini diambil dari session login
    const currentUser = "Siti (Finance)"; 
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center items-baseline gap-2 border-b border-gray-300 pb-4 max-w-[280px] mx-auto focus-within:border-blue-600 transition-colors">
            ...
            <input 
              ...
              placeholder="0"
              className="text-5xl text-gray-800 font-light w-full focus:outline-none bg-transparent tracking-tight text-center"
            />
          </div>
        </div>
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <textarea 
              ...
              placeholder="Tulis detail pemasukan..."
              rows={3}
              className="w-full p-3 bg-gray-50 border border-gray-200 focus:outline-none focus:border-blue-500 rounded-lg resize-none transition-colors"
            ></textarea>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <button type="button" onClick={() => setQuickTag('Divisi IT')} className="bg-gray-100 text-gray-700 text-xs py-2 px-3 font-medium hover:bg-blue-100 hover:text-blue-700 transition rounded-lg">Divisi IT</button>
              <button type="button" onClick={() => setQuickTag('Divisi HR')} className="bg-gray-100 text-gray-700 text-xs py-2 px-3 font-medium hover:bg-blue-100 hover:text-blue-700 transition rounded-lg">Divisi HR</button>
              <button type="button" onClick={() => setQuickTag('Uang Muka')} className="bg-gray-100 text-gray-700 text-xs py-2 px-3 font-medium hover:bg-blue-100 hover:text-blue-700 transition rounded-lg">Uang Muka</button>
            </div>
          </div>
        </form>
      </main>
