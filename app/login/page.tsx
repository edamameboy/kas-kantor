    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-sm bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <input type="tel" placeholder="Nomor Handphone" required value={phone} onChange={(e)=>setPhone(e.target.value)} className="w-full p-3 text-gray-600 bg-gray-50 border border-gray-200 rounded-lg focus:outline-blue-500" />
          <input type="password" placeholder="Password" required value={password} onChange={(e)=>setPassword(e.target.value)} className="w-full p-3 text-gray-600 bg-gray-50 border border-gray-200 rounded-lg focus:outline-blue-500" />
